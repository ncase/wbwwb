...
var textStrings_DE = {
  ...
  areTheyYelling:
    "(erwische sie, *w\xE4hrend* sie sich gegenseitig anschreien)",
...
var textStrings_PT_BR = {
  //I put that way because portuguese from Brazil (PT_BR) is a little different than portuguese from Portugal (PT_PT)
  // Act 1
  ...
  somethingInteresting:
    "(você tem que pegá-los fazendo *algo* interessante...)",
  ...
  areTheySnubbed:
    "(você tem que pegá-los *enquanto* eles afrontam os círculos)", // not used
  everyoneHates: "TODO MUNDO ODEIA TODO MUNDO!!1!",
  almostEveryoneHates: "QUASE TODO MUNDO ODEIA TODO MUNDO...",
  squaresHateCircles: "QUADRADOS ODEIAM CÍRCULOS",
  circlesHateSquares: "CÍRCULOS ODEIAM QUADRADOS",
...
var textStrings_ES = {
  ...
  warning:
    "advertencia: el siguente programa contiene escenas esnobismo,\nrudeza & asesinato masivo.\ntelevidente tenga discreción.",
  ...
  WBWWB: "We become what we behold.",
  WSOTATOTSU:
    "Nosotros damos forma a nuestras herramientas y luego nuestras herramientas nos dan forma a nosotros.",
...
var textStrings_TR = {
  // Act 1
  niceHat: "VAAY NE GÜZEL ŞAPKA",
  outtaHere: "evet hadi buradan uzaklaş",
  getARoom: "İĞRENÇ, GİDİN BİR ODA TUTUN",
  notCoolAnymore: "Şapkalar artık havalı değil",
  tvOnTv: "Bir televizyon... TELEVİZYONDA!",
  cricky: "KÜÇÜK CIRİK <3",
  tooManyCrickets: "tamam bu kadar çok cırcır böceği fazla",
  normalPeep: "sıradan biri",
  normalPeeps: "sadece birkaç sıradan insan",
  wowNothing: "VAAAY, HİÇBİR ŞEY YOK",
  ...
  whoIsScreaming: "(kimin onlara bağırdığını yakalamalısın)",
  ...
  nerdsNow: "bu inek tipli insanlar şimdi ne yapıyor",
  schockedPeep: "bu insan neden şok olmuş?",
  whatever: "her neyse",

  // Act 3
  ellipsis: ". . .",
  coolNoMore: "şapkalar artık havalı değil, duymadın mı?",
  beScared: "KORK. ÖFKELEN.",

  // MANIFESTO
  manifesto: [
    //"as if you viewers want GOOD news"       ,
    "kim *insanların anlaştığını* izlemek için televizyon izler?",
    "barış sıkıcıdır. şiddet viral olur.",
    //"peace is boring. conflict gets clicks." ,
    "ve her hikayenin bir çatışmaya ihtiyacı vardır, yani...",
    //"...GIVE THE AUDIENCE WHAT THEY WANT."   ,
  ...
  warning:
    "uyarı: bu program\nkibirlilik, kabalık & toplu\ncinayet sahneleri içermektedir.\nizleyici takdiri tavsiye edilir.",

  // (cam-instructions.png) Camera Instructions
  pointAndClick: "İŞARET ET & TIKLA",

  // (chyron3.png)
  chyronNothing: "VAAAY, BU *HİÇBİR ŞEY*",
  ...
  // (credits0007.png)
  lastButNotLeast: "ve son olarak ama bir o kadar önemli,",
  ...
  toBeContinued: "(devamı gelecek!)",

  // (quote0002.png)
  WBWWB: "Neye bakarsak ona dönüşürüz.",
  WSOTATOTSU:
    "Biz araçlarımızı şekillendiririz ve sonra araçlarımız bizi şekillendirir.",

  // (quote0003.png)
  MarshallMcLuhan: "Marshall McLuhan",

  // (quote0004.png)
  misatrributed: "(yanlış şekilde ona atfedildi)",
};
