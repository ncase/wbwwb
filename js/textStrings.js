...
var textStrings_GR = {
	// Act 1
	"niceHat": "ΩΡΑΙΟ ΚΑΠΕΛΟ",
	"outtaHere": "ναι φύγε από δω",
	"getARoom": "ΑΗΔΙΑ, ΝΑ ΠΑΤΕ ΑΛΛΟΥ",
	"notCoolAnymore": "ναι τα καπέλα δεν είναι πια κουλ",
	"tvOnTv": "ΤΗΛΕΟΡΑΣΗ... ΣΤΗΝ ΤΗΛΕΟΡΑΣΗ!",
	"cricky": "ΤΡΙΖΕΙ ΛΙΓΟ <3",
	"tooManyCrickets": "οκ πολλά τριζόνια",
	"normalPeep": " απλώς ένας κανονικός τύπος",
	"normalPeeps": "απλώς μερικοί κανονικοί τύποι",
	"wowNothing": "ΟΥΑΟΥ, ΕΙΝΑΙ ΤΟ ΤΙΠΟΤΑ",
	...
	"whoScaresThem": "(πρέπει επίσης να πιάσεις ΠΟΙΟΝ φοβούνται...)",
	"areTheyScared": "(πρέπει να τους πιάσεις να ΦΟΒΟΥΝΤΑΙ από τετράγωνο)", // not used
	"squaresSnubCircles": "ΤΑ ΤΕΤΡΑΓΩΝΑ ΣΝΟΜΠΑΡΟΥΝ ΤΟΥΣ ΚΥΚΛΟΥΣ",
	"areTheySnubbed": "(πρέπει να τους πιάσεις ενώ σνομπάρουν κύκλο...)", // not used
	"everyoneHates": "ΟΛΟΙ ΜΙΣΟΥΝ ΟΛΟΥΣ!!1!",
	"almostEveryoneHates": " ΣΧΕΔΟΝ ΟΛΟΙ ΜΙΣΟΥΝ ΟΛΟΥΣ...",
	"squaresHateCircles": "ΤΑ ΤΕΤΡΑΓΩΝΑ ΜΙΣΟΥΝ ΤΟΥΣ ΚΥΚΛΟΥΣ",
	"circlesHateSquares": "ΟΙ ΚΥΚΛΟΙ ΜΙΣΟΥΝ ΤΑ ΤΕΤΡΑΓΩΝΑ"",
	"areTheyYelling": "(πρέπει να τους πιάσεις να ΦΩΝΑΖΟΥΝ σε άλλους)", // not used
	"nerdsNow": "τί κάνουν αυτοί οι σπασίκλες τώρα",
	"schockedPeep": "γιατί είναι αυτός o τύπος σοκαρισμένος;",
	"whatever": "τέλος πάντων",

	// Act 3
	"ellipsis": ". . .",
	"coolNoMore": "τα καπέλα δεν είναι πια κουλ, δεν άκουσες;",
	"beScared": "ΤΡΟΜΑΞΕ. ΘΥΜΩΣΕ.",

	// MANIFESTO
	"manifesto": [
		//"λες κι εσείς οι θεατές θέλετε ΚΑΛΑ νέα"       ,
		"ποιος μπαίνει να δει *ανθρώπους να τα πηγαίνουν καλά*;",
		"η ειρήνη είναι βαρετή. η βία γίνεται viral.",
		//"η ειρήνη είναι βαρετή. η σύγκρουση φέρνει κλικς." ,
		"και κάθε ιστορία χρειάζεται μια σύγκρουση, οπότε...",
		//"...ΔΩΣΕ ΣΤΟ ΚΟΙΝΟ ΑΥΤΟ ΠΟΥ ΘΕΛΕΙ."   ,
		"ΔΩΣΕ ΣΤΟ ΚΟΙΝΟ ΑΥΤΟ ΠΟΥ ΘΕΛΕΙ."
	],
	...
	// (logo.png) Post Credits
	"logoWBWWB": "ΜΟΙΡΑΣΟΥ ΤΟΝ ΠΟΝΟ:",

	// (end_prototype.png)
	"endOfPrototype": "ΤΕΛΟΣ ΠΡΩΤΟΤΥΠΟΥ",
	"toBeContinued": "(συνεχίζεται!)",
