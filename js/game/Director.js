...
var textStrings_EN = {
    ...
    "areTheyScared"        : "(ya gotta catch 'em *being* scared by a square)"       ,
    "squaresSnubCircles"   : "SQUARES SNUB CIRCLES"                                  ,
    "areTheySnubbed"       : "(ya gotta catch 'em *while* snubbing a circle)"        ,
...
var textStrings_DE = {
    ...
    "normalPeep"           : "Nur ein gew\xF6hnlicher Typ."                                      ,
    "normalPeeps"          : "Nur ein paar gew\xF6hnliche Typen."                                ,
    "wowNothing"           : "Wow! Nichts! Gar nix!"                                             ,
    
    // Act 2
    "crazySquareAttacks"   : "Verr\xFCcktes Quadrat greift an!"                                  ,
    "justMissed"           : "Ooooh, knapp verpasst."                                            ,
    "somethingInteresting" : "(du musst sie schon erwischen, wenn was *Interessantes* passiert)" ,
    "whoIsScreaming"       : "(erwische, *wer* sie anschreit)"                                   ,
    "circleFearsSquares"   : "KREIS F\xDCRCHTET QUADRATE!"                                       ,
    "whoScaresThem"        : "(erwische, *wen* sie f\xFCrchten)"                                 ,
    "areTheyScared"        : "(erwische sie, *wenn* sie fl\xFCchten)"                            ,
    "squaresSnubCircles"   : "QUADRATE <SNUB> KREISE"                                  ,
    ...
    "beScared"             : "HAB ANGST! SEI B\xD6SE!"                                           ,
};
